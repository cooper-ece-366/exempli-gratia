package edu.cooper.ece366.yahoofinance.api;
...
import edu.cooper.ece366.yahoofinance.api.histquotes.HistoricalQuote;
import edu.cooper.ece366.yahoofinance.api.quotes.fx.FxSymbols;
...
import edu.cooper.ece366.yahoofinance.api.histquotes.HistQuotesRequest;
import edu.cooper.ece366.yahoofinance.api.histquotes.Interval;
import edu.cooper.ece366.yahoofinance.api.quotes.fx.FxQuote;
import edu.cooper.ece366.yahoofinance.api.quotes.csv.FxQuotesRequest;
import edu.cooper.ece366.yahoofinance.api.quotes.csv.StockQuotesData;
import edu.cooper.ece366.yahoofinance.api.quotes.csv.StockQuotesRequest;
import edu.cooper.ece366.yahoofinance.api.quotes.query1v7.FxQuotesQuery1V7Request;
import edu.cooper.ece366.yahoofinance.api.quotes.query1v7.StockQuotesQuery1V7Request;
...
public class YahooFinance {
    ...
    * with its {@link StockQuote}, {@link StockStats}
    * and {@link StockDividend} member fields
    ...
    * The Stock objects have their {@link StockQuote}, {@link StockStats}
    * and {@link StockDividend} member fields
    * filled in with the available data.
    * <p>
    ...
    */
     ...
     * Some common symbols can easily be found in the ENUM {@link FxSymbols}
